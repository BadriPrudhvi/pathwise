...
const NavLink: React.FC<NavLinkProps> = ({ href = "#", children, hasDropdown = false, className = "", onClick }) => (
   ...
   >
     ...
     {!hasDropdown && (
         <motion.div
           className="absolute bottom-[-2px] left-0 right-0 h-[1px] bg-green-500"
...
const DropdownMenu: React.FC<DropdownMenuProps> = ({ children, isOpen }) => (
   <AnimatePresence>
     {isOpen && (
       ...
       >
           <div className="bg-gray-900 border border-gray-700/50 rounded-md shadow-xl p-2">
               {children}
           </div>
       </motion.div>
     )}
...
const InteractiveHero: React.FC = () => {
  ...
  return (
    <div className="pt-[100px] relative bg-gray-900 text-gray-300 min-h-screen flex flex-col overflow-x-hidden">
        <canvas ref={canvasRef} className="absolute inset-0 z-0 pointer-events-none opacity-80" />
        <div className="absolute inset-0 z-1 pointer-events-none" style={{
            background: 'linear-gradient(to bottom, transparent 0%, rgb(17 24 39) 90%), radial-gradient(ellipse at center, transparent 40%, rgb(17 24 39) 95%)'
        }}></div>
        ...
        >
            <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-[70px]">
                <div className="flex items-center flex-shrink-0">
                    ...
                    <span className="text-xl font-bold text-white ml-2">Pathwise</span>
                </div>
                ...
                <div className="hidden md:flex items-center justify-center flex-grow space-x-6 lg:space-x-8 px-4">
                    ...
                    >
                        ...
                        <DropdownMenu isOpen={openDropdown === 'features'}>
                            <DropdownItem href="#">AI Goal Scoping</DropdownItem>
                            <DropdownItem href="#">Skill Assessment</DropdownItem>
                            <DropdownItem href="#">Adaptive Learning</DropdownItem>
                            <DropdownItem href="#">Progress Tracking</DropdownItem>
                            <DropdownItem href="#">AI Assistant</DropdownItem>
                        </DropdownMenu>
                    </div>
                ...
                <div className="flex items-center flex-shrink-0 space-x-4 lg:space-x-6">
                    ...
                    <motion.a
                        href="#"
                        className="bg-green-600 text-white px-4 py-[6px] rounded-md text-sm font-semibold hover:bg-green-700 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md"
        ...
        <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
            ...
            <motion.div
                ...
                className="mb-6"
            >
                <ShinyText text="✨ AI-Powered Personalized Learning" className="bg-gray-800 border border-gray-700 text-green-500 px-4 py-1 rounded-full text-xs sm:text-sm font-medium cursor-pointer hover:border-green-500/50 transition-colors" />
            </motion.div>
            ...
            >
                ...
                <span className="inline-block h-[1.2em] sm:h-[1.2em] lg:h-[1.2em] overflow-hidden align-bottom">
                    <RotatingText
                        texts={['PERSONALIZED', 'ADAPTIVE', 'INTELLIGENT', 'CUSTOM', 'UNIQUE']}
                        mainClassName="text-green-500 mx-1"
                        staggerFrom={"last"}
                        initial={{ y: "-100%", opacity: 0 }}
                        animate={{ y: 0, opacity: 1 }}
            ...
            >
                <input
                    ...
                    className="flex-grow w-full sm:w-auto px-4 py-2 rounded-md bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
                />
                <motion.button
                    type="submit"
                    onClick={handleStartJourney}
                    className="w-full sm:w-auto bg-green-600 text-white px-5 py-2 rounded-md text-sm font-semibold hover:bg-green-700 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md flex-shrink-0"
                    whileHover={{ scale: 1.03, y: -1 }}
                    whileTap={{ scale: 0.97 }}
                    transition={{ type: "spring", stiffness: 400, damping: 15 }}
                >
            ...
            >
                <span className="text-xs uppercase text-gray-500 tracking-wider font-medium">Trusted by learners worldwide</span>
                <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-1 text-gray-400">
                    <span className="flex items-center whitespace-nowrap">10K+ Active Learners</span>
                    <span className="flex items-center whitespace-nowrap">500+ Learning Paths</span>
                    <span className="flex items-center whitespace-nowrap">95% Goal Achievement</span>
                </div>
            </motion.div>
